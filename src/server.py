...
from ssh_bridge import execute_command, read_remote_file
...
@mcp.tool(name="get_file_contents", description="Read a remote file over SSH and return its contents as raw text or base64.")
def get_file_contents(
    ...
    _require_api_key(headers, context_label="tool:get_file_contents")
