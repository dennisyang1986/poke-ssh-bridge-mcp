...
Poke SSH Bridge MCP enables AI agents to securely execute commands and retrieve system information from remote Linux servers over SSH. It provides two core tools:
...
```bash
git clone https://github.com/your-username/poke-ssh-bridge-mcp.git
